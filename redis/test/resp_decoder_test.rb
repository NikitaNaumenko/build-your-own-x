...
class TestRESPDecoder < Minitest::Test
  ...
  def test_bulk_string
    ...
    assert_equal 'HELLO', RESPDecoder.decode("$5\r\nHELLO\r\n")
    assert_raises(IncompleteRESP) { RESPDecoder.decode('$') }
    assert_raises(IncompleteRESP) { RESPDecoder.decode('$OK') }
  ...
  def test_array
    assert_equal ['PONG'], RESPDecoder.decode("*1\r\n$4\r\nPONG\r\n")
    assert_equal ['PING'], RESPDecoder.decode("*1\r\n$4\r\nPING\r\n")
    assert_equal %w[ECHO hey], RESPDecoder.decode("*2\r\n$4\r\nECHO\r\n$3\r\nhey\r\n")
    assert_raises(IncompleteRESP) { RESPDecoder.decode('*') }
  ...
  def test_wrong_operation
    assert_raises(RuntimeError) { RESPDecoder.decode("?1\r\nCODE\r\n") }
  end
end
